 ...
 *
 * Must be a `__ModuleLoader__` factory bundle (not raw ESM): application combo
 * scripts concatenate every client.js, and an `import` would SyntaxError the
 * whole combo — marketplace, sidebar, and the rest of that batch included.
 * React comes from the host seed table via `require`. No JSX: elements are
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const name = 'dsh-launcher-client'
